...
namespace SeleniumTests
{
    ...
    public class Mtrsrms
    {
        ...
        public void TheMtrsrmsTest()
        {
            ...
            driver.FindElement(By.Id("input-email")).SendKeys("dzvolta@gmail.com");
            driver.FindElement(By.Id("input-password")).Click();
            driver.FindElement(By.Id("input-password")).Clear();
            driver.FindElement(By.Id("input-password")).SendKeys("sifra1");
            driver.FindElement(By.Id("input-password")).SendKeys(Keys.Enter);
            Thread.Sleep(3000);
            driver.FindElement(By.XPath("//form[@id='form-currency']/div/button/span")).Click();
